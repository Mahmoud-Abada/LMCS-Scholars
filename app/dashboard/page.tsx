              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 w-full">
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Here&rsquo;s an overview of your Lab. Manage publications and researchers with ease!
                  </p>
                </div>
                <div className="flex items-center gap-2 w-full sm:w-auto">
                  <Button className="px-3 w-full sm:w-auto">Add Publication</Button>
                  <Button className="px-3 w-full sm:w-auto">Add Researcher</Button>
                </div>
              </div>
