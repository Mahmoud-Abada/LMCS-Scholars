  ...
  return (
    <div className="flex min-h-screen bg-background">
      <SidebarProvider>
        <div className="flex-1 p-8 ml-5">
          <div className="flex justify-between items-center mb-8">
            <h1 className="text-3xl font-bold text-gray-900">Tableau de Bord des Analyses de Recherche</h1>
            <div className="flex gap-4">
              <Select value={timeRange} onValueChange={setTimeRange}>
                <SelectTrigger className="w-[180px]">
                  <SelectValue placeholder="Plage Temporelle" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="1year">Dernière Année</SelectItem>
                  <SelectItem value="3years">3 Dernières Années</SelectItem>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4 mb-8">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-gray-500">Dernières {timeRange === "all" ? "toutes les années" : timeRange}</p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader className="flex flex-row items-center justify-between pb-2">
            ...
            <TabsContent value="overview">
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                <Card className="col-span-2">
                  <CardHeader>
                    <CardTitle>Tendances des Publications & Citations</CardTitle>
                ...
                <Card>
                  <CardHeader>
                    <CardTitle>Types de Publications</CardTitle>
                    <CardDescription>Répartition des types de publications</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="h-[300px]">
                      <ResponsiveContainer width="100%" height="100%">
                ...
                <Card className="col-span-2">
                  <CardHeader>
                    <CardTitle>Classements des Lieux</CardTitle>
              ...
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                <Card className="col-span-2">
                  <CardHeader>
                    ...
                    <CardDescription>Publications cumulées au fil du temps</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="h-[300px]">
                      <ResponsiveContainer width="100%" height="100%">
              ...
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Publications en conférence vs journal</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="h-[300px]">
                      <ResponsiveContainer width="100%" height="100%">
