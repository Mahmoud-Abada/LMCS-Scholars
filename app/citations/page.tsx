  ...
  const fetchData = async () => {
    try {
      ...
      const response = await fetch(
        `/api/analytics/citations?${params.toString()}`
      );
      ...
      <div className="container mx-auto py-8 space-y-6">
        ...
        <Card>
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <Input
              ...
              onChange={(e) =>
                setFilters({ ...filters, researcherId: e.target.value })
              }
            />
            <Input
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <MetricCard
            ...
            value={data.high_level_metrics.total_citations}
          />
          <MetricCard
            title="Total Publications"
            value={data.high_level_metrics.total_publications}
          />
          <MetricCard
            title="Avg Citations"
            value={data.high_level_metrics.avg_citations}
          />
          <MetricCard
            title="Max Citations"
            value={data.high_level_metrics.max_citations}
          />
        </div>
                ...
                data={[
                  {
                    name: "Single",
                    value:
                      data.collaboration_metrics.find(
                        (m) => m.collaboration_type === "single-author"
                      )?.total_citations || 0,
                  },
                  {
                    name: "Team",
                    value:
                      data.collaboration_metrics.find(
                        (m) => m.collaboration_type === "intra-team"
                      )?.total_citations || 0,
                  },
                  {
                    name: "Cross",
                    value:
                      data.collaboration_metrics.find(
                        (m) => m.collaboration_type === "inter-team"
                      )?.total_citations || 0,
                  },
                ]}
